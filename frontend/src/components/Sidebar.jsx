      ...
      >
        ...
        <div className={`flex items-center h-16 px-4 border-b border-gray-200 ${sidebarOpen ? 'justify-between' : 'justify-center'}`}>
          {sidebarOpen ? (
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-base font-bold text-gray-800 tracking-tight">WatchTowerAI</h1>
                <p className="text-[9px] text-accent/60 font-semibold uppercase tracking-[0.2em]">Surveillance</p>
              </div>
            </div>
          ) : (
        ...
        {sidebarOpen && (
          <div className="px-6 pt-5 pb-2">
            <p className="text-[9px] text-gray-400 font-semibold uppercase tracking-[0.15em]">Navigation</p>
          </div>
        )}
          ...
          <div className="px-4 pb-3">
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider">System</span>
              </div>
              <p className="text-[10px] text-gray-400">v1.0.0 · ONNX Runtime</p>
            </div>
          </div>
        )}
        ...
        <button
          ...
          className="hidden md:flex items-center justify-center h-12 border-t border-gray-200 text-gray-400 hover:text-gray-600 transition-colors"
        >
